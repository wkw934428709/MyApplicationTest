...
public class CycleView extends View {
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        boolean tt =  super.dispatchKeyEvent(event);
        Log.e("11", " CycleView ::dispatchKeyEvent : " + tt);
        switch (event.getAction()){
            case MotionEvent.ACTION_DOWN:
                mH.requestDisallowInterceptTouchEvent(true);
                break;
            case  MotionEvent.ACTION_MOVE:
                mH.requestDisallowInterceptTouchEvent(false);
                break;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        Log.e("11", " CycleView ::onTouchEvent : " + tt);
        return true;
    }
}